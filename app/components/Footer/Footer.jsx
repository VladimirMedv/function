...
export default function Footer() {
  return (
    <footer className='bg-footer text-text 3xl:pt-[150px] md:py-[80px] py-[60px] 3xl:pb-[100px] 3xl:gap-[6.25rem] flex flex-col gap-16'>
      <Contacts />
      <div className='flex flex-row 3xl:px-56 2lg:px-40 md:px-[1.875rem] px-5'>
