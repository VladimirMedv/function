  ...
  return (
    <div className='flex flex-col items-center justify-center'>
      ...
      <Link
        ...
        className='3xl:text-[6.563rem] 2lg:text-[5.125rem] md:text-[3.313rem] sm:text-[2rem] underline cursor-pointer hover:text-secondary transition-colors duration-300 -tracking-[0.03em] font-medium 3xl:leading-[131px] 2lg:leading-[82px] md:leading-[66px] leading-[42px]'
      >
