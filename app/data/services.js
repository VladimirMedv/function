const SERVICES_DATA = [
  ...
  },
  {
    ...
    description: `Creating a distinctive identity for products to stand out in the market, emphasizing the product's unique selling points and aligning with the brand's core values.`,
    steps: [
      // Add specific steps for Product Identity here
    ],
  },
  {
    href: '/services/personal-identity',
    label: 'Personal identity',
    description: `Developing a personalized visual identity to reflect individual values, goals, and personality, ensuring a consistent and professional presence across platforms.`,
    steps: [
      // Add specific steps for Personal Identity here
    ],
  },
  {
    href: '/services/brand-support',
    label: 'Brand support',
    description: `Ongoing assistance in maintaining, evolving, and optimizing the brand’s identity and communication strategies to stay competitive and relevant.`,
    steps: [
      // Add specific steps for Brand Support here
    ],
  },
  {
    href: '/services/naming',
    label: 'Naming',
    description: `Crafting unique and memorable names that resonate with the target audience and reflect the brand’s essence, values, and objectives.`,
    steps: [
      // Add specific steps for Naming here
    ],
  },
  {
    href: '/services/logo',
